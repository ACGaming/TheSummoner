...
{
    public static final List<SummonGroup> SUMMONGROUPS = new ArrayList<>();
    public static final List<SummonGroup> BOSSSUMMONGROUPS = new ArrayList<>();

    static Random rand = new Random();
    static Map<Integer, List<NBTTagCompound>> nbtTagCompounds = new HashMap<>();
    static Map<Integer, Integer> weights = new HashMap<>();
    ...
    {
        List<SummonGroup> WEIGHTEDGROUPS = new ArrayList<>();
