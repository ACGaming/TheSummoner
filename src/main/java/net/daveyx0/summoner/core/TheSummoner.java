...
@Mod(modid = TheSummonerReference.MODID,
    name = TheSummonerReference.NAME,
    version = TheSummonerReference.VERSION,
    acceptedMinecraftVersions = "[1.12]",
    guiFactory = "net.daveyx0.summoner.config.TheSummonerFactoryGui",
    dependencies = "required-after:multimob")
